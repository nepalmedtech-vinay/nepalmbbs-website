...
**78 is "incomplete", and that is the right reading.** The brief's own scale
...
is roughly 78 → 88. The last dozen points need a person with a browser and
...
2. **Document centre** (Journey 6→8, UX 11→13) — buildable now from the
   Commission's published document requirements, which are already sourced
   in `knowledge.json`.
