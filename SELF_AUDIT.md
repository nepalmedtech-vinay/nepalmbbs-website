...
- **Visual 17/20 and UX 13/15 are mine.** Chunk 7 designed the interiors of
...
Realistically that is 87 → 91 by working, and the last nine points need
...
3. **Finish the page interiors** (Visual 17→19). Chunk 7 did `/`, `/colleges`,
